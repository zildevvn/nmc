<section class="nmc-section contact-section">
    ...
    <div class="container">
        <div class="contact-section-content text-center">
            <h2 class="contact-section-content__title ncm-heading-highlight mb-0">CONTACT</h2>
            <p class="contact-section__desc h2 mb-0">お問い合わせ</p>
            <p class="mb-0">ご不明な点はお気軽にお問い合わせください</p>

            <div class="contact-section__action d-flex justify-content-center align-items-center flex-wrap"> 
