...
if ( ! function_exists( 'nmc_template_news_hero_header' ) ) {
	function nmc_template_news_hero_header() {
        ...
        <div class="news-hero text-center text-white">
            <div class="container">
                <div class="hero-inner">
                    <h2 class="nmc-title">Blog</h2>
                    <p class="nmc-subtitle"><?= get_bloginfo( 'description' ); ?></p>
                </div>
            </div>
        </div>
