 ...
 * @return void
 */
add_action('nmc_hook_header', 'nmc_header_template');
function nmc_header_template()
{
 ...
 * @return void
 */
add_action('nmc_hook_footer', 'nmc_footer_template');
function nmc_footer_template()
{
 ...
 * @return void
 */
add_action('nmc_hook_search', 'nmc_search_template');
function nmc_search_template()
{
 ...
 * @return void
 */
add_action('nmc_hook_post_loop_item', 'nmc_post_loop_item_template', 20, 2);
function nmc_post_loop_item_template($post_id, $index)
{
