...
?>
	...
	<?php if(!empty($search_query)): ?>
		<div class="nmc-results-search-section">
			<div class="container">
				<?php if (have_posts()): ?>
					<?php
					global $wp_query;
					...
					echo '<h4 class="nmc-results-search-section__total ">';
					...
					<div class="nmc-results-search-section__list d-flex flex-wrap">
					...
					<?php
						nmc_the_posts_navigation([
							'prev_text' => nmc_svg_icon('arrow_prev') . __('Prev'),
							'next_text' => __('Next') . nmc_svg_icon('arrow_next'),
						]);
						wp_reset_postdata();
					?>
				<?php else: ?>
					<h3 class="nmc-results-search-section__total" style="text-align: center;">No results found</h3>
				<?php endif; ?>
			</div>	
		</div>
	<?php endif;?>
